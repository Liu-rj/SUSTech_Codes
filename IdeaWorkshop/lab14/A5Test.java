...
import source_code_Refactoring.*;
import source_code_Refactoring.Rental;
...
public class A5Test {
    ...
    @Test
    public void check_Movie_class() throws Exception {
        Class.forName("source_code_Refactoring.Movie");
    }

    @Test
    public void check_Rental_class() throws Exception {
        Class.forName("source_code_Refactoring.Rental");
    }

    @Test
    public void check_DateRange_class() throws Exception {
        Class.forName("source_code_Refactoring.DateRange");
    }

    @Test
    public void check_Price_class() throws Exception {
        Class<?> priceClass = Class.forName("source_code_Refactoring.Price");
    ...
    public void check_Price_subclass() throws Exception {
        Class<?> priceClass = Class.forName("source_code_Refactoring.Price");
        Class<?> childrensPriceClass = Class.forName("source_code_Refactoring.ChildrensPrice");
        Class<?> newReleasePriceClass = Class.forName("source_code_Refactoring.NewReleasePrice");
        Class<?> regularPriceClass = Class.forName("source_code_Refactoring.RegularPrice");
    ...
    public void check_FrequentRenterPoints() throws Exception {
        Class<?> movieClass = Class.forName("source_code_Refactoring.Movie");
        Class<?> rentalClass = Class.forName("source_code_Refactoring.Rental");
        Class<?> priceClass = Class.forName("source_code_Refactoring.Price");
