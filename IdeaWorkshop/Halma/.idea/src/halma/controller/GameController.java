...
public class GameController implements InputListener {
    ...
    public void onPlayerClickSquare(ChessBoardLocation location, SquareComponent component) {
        ...
        model.setLocationArrayList(new ArrayList<>());
    }
...
//            for (ChessBoardLocation chessBoardLocation : model.getLocationArrayList()) {
//                chessBoardComponent.getGridAt(chessBoardLocation).setPossible(!chessBoardComponent.getGridAt(chessBoardLocation).isPossible());
//            }
        ...
        Timer timer = new Timer(1000,e -> {
            if (time > 0){
                ...
                if (chessComponent != null) {
                    chessComponent.setSelected(!chessComponent.isSelected());
